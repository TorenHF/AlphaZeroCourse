...
class AlphaZeroParallel:
    ...
    def selfPlay(self):
        ...
        while len(spGames) > 0:
            ...
            for i in range(len(spGames))[::-1]:
                ...
                if is_terminal:
                    for hist_neutral_state, hist_action_probs, hist_player, hist_q_value in spg.memory:
    ...
    def learn(self):
        for iteration in range(self.args['num_iterations']):
            ...
            torch.save(self.model.state_dict(), f"model_{iteration}_{self.game}_q-test.pt" )
            torch.save(self.optimizer.state_dict(), f"optimizer_{iteration}_{self.game}_q-test.pt")
